...
proxies = {
           'http': 'http://xawjfarc-rotate:qrgpay0eiezy@p.webshare.io:80/',
           'https': 'http://xawjfarc-rotate-rotate:qrgpay0eiezy@p.webshare.io:80/'
}
...
async def helpstr(message: types.Message):
    ...
    btns = types.InlineKeyboardButton("Bot Source", url="http://rpaleaks.cf")
